...
namespace revenue_api.Migrations
{
    ...
    [Migration("20240626102640_AddSubscriptionsUpdatePaymentToIncludeSubscription")]
    partial class AddSubscriptionsUpdatePaymentToIncludeSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("revenue_api.Models.Auth.AppUser", b =>
                {
            ...
            modelBuilder.Entity("revenue_api.Models.Subscription", b =>
                {
                    ...
                    b.Property<int>("SubcriptionOfferSubscriptionOfferId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubcriptionOfferSubscriptionOfferId");
            ...
            modelBuilder.Entity("revenue_api.Models.Payment", b =>
                {
                    ...
                    b.HasOne("revenue_api.Models.Subscription", "Subscription")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("revenue_api.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("revenue_api.Models.SubcriptionOffer", "SubcriptionOffer")
                        .WithMany()
                        .HasForeignKey("SubcriptionOfferSubscriptionOfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Client");

                    b.Navigation("SubcriptionOffer");
                });
            ...
            modelBuilder.Entity("revenue_api.Models.Software", b =>
                {
                    ...
                    b.Navigation("SubcriptionOffers");
                });
